...
pub fn generate_config(config: &AgentConfig) -> String {
    ...
    yaml.push_str("# HyperCoWork Configuration\n");
    yaml.push_str("# Generated by hypercowork-installer\n\n");
...
async fn main() {
    println!();
    println!("{}", console::style(" ╔═══════════════════════════════════════╗").cyan());
    println!("{}", console::style(" ║   HYPER · AGENT · COWORK · FLEET     ║").cyan());
    println!("{}", console::style(" ║          CONTROL SYSTEM               ║").cyan());
    println!("{}", console::style(" ╚═══════════════════════════════════════╝").cyan());
    println!();
    ...
    println!("  2. Run: cargo run -p hypercowork-server -- --config {:?}", config_path);
    println!();
}
